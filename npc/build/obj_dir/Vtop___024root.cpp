...
VL_INLINE_OPT void Vtop___024root___sequent__TOP__1(Vtop___024root* vlSelf) {
    ...
    // Body
    if (vlSelf->rst_n) {
        vlSelf->top__DOT__DivSel_ex = vlSelf->top__DOT__DivSel_id;
        vlSelf->top__DOT__DivEn_ex = ((IData)(vlSelf->top__DOT__DivEn_id) 
                                      & 1U);
    } else {
        vlSelf->top__DOT__DivSel_ex = 0U;
        vlSelf->top__DOT__DivEn_ex = 0U;
    }
    if (vlSelf->rst_n) {
    ...
    vlSelf->top__DOT__trap_ls = ((IData)(vlSelf->rst_n) 
                                 & (IData)(vlSelf->top__DOT__trap_ex));
    if (vlSelf->rst_n) {
        if (((IData)(vlSelf->top__DOT__hazard_detect_u__DOT__hazard) 
             | (IData)(vlSelf->top__DOT__is_jump))) {
            vlSelf->top__DOT__trap_ex = 0U;
        } else if ((1U & (~ (IData)(vlSelf->top__DOT__hazard_detect_u__DOT__hazard)))) {
            vlSelf->top__DOT__trap_ex = vlSelf->top__DOT__trap_id;
        }
    } else {
        vlSelf->top__DOT__trap_ex = 0U;
    }
...
VL_INLINE_OPT void Vtop___024root___sequent__TOP__6(Vtop___024root* vlSelf) {
    ...
    __Vtemp18[1U] = 0U;
    __Vtemp18[2U] = 0U;
    VL_EXTEND_WQ(65,64, __Vtemp19, vlSelf->top__DOT__ex_stage_u__DOT__rs1);
    VL_EXTEND_WQ(65,64, __Vtemp20, (~ vlSelf->top__DOT__ex_stage_u__DOT__rs2));
                    ...
                    ? (((QData)((IData)((0xffffU & (IData)(
                        ...
                        << 0x30U) | (((QData)((IData)(
                                      ...
                                      << 0x28U) | (0xffffffffffULL 
                                                   & vlSelf->top__DOT__ls_u__DOT__lsu_u__DOT__rd_data_base_buf)))
                    : (((QData)((IData)((((IData)((vlSelf->top__DOT__ls_u__DOT__lsu_u__DOT__rd_data_base_buf 
                                                   >> 0x28U)) 
                                          << 8U) | 
                                         (0xffU & (IData)(vlSelf->top__DOT__ls_u__DOT__wr_data))))) 
                        << 0x20U) | (QData)((IData)(vlSelf->top__DOT__ls_u__DOT__lsu_u__DOT__rd_data_base_buf)))));
    } else {
        vlSelf->top__DOT__ls_u__DOT__lsu_u__DOT__rd_data_b 
            = (0xffU & ((1U & (IData)((vlSelf->top__DOT__alures_ls 
                                       >> 1U))) ? (
                         ...
                         : ((1U & (IData)(vlSelf->top__DOT__alures_ls))
                             ? (IData)((vlSelf->top__DOT__ls_u__DOT__lsu_u__DOT__rd_data_base_buf 
                                        >> 8U)) : (IData)(vlSelf->top__DOT__ls_u__DOT__lsu_u__DOT__rd_data_base_buf))));
        vlSelf->top__DOT__ls_u__DOT__lsu_u__DOT__rd_data_h 
            = (0xffffU & ((1U & (IData)((vlSelf->top__DOT__alures_ls 
                                         >> 1U))) ? 
                          ((1U & (IData)(vlSelf->top__DOT__alures_ls))
                                              ...
                                              | (QData)((IData)(
                                                                ((0xff0000U 
                                                                 ...
                                                                 | (0xffffU 
                                                                    & (IData)(vlSelf->top__DOT__ls_u__DOT__lsu_u__DOT__rd_data_base_buf)))))))
                : ((1U & (IData)(vlSelf->top__DOT__alures_ls))
                    ? ((0xffffffffffff0000ULL & vlSelf->top__DOT__ls_u__DOT__lsu_u__DOT__rd_data_base_buf) 
                       | (QData)((IData)(((0xff00U 
                                           & ((IData)(vlSelf->top__DOT__ls_u__DOT__wr_data) 
                                              << 8U)) 
                                          | (0xffU 
                                             & (IData)(vlSelf->top__DOT__ls_u__DOT__lsu_u__DOT__rd_data_base_buf))))))
                    : ((0xffffffffffffff00ULL & vlSelf->top__DOT__ls_u__DOT__lsu_u__DOT__rd_data_base_buf) 
