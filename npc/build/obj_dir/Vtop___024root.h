...
VL_MODULE(Vtop___024root) {
  public:
    ...
    struct {
        ...
        CData/*1:0*/ top__DOT__axi_ls_i__DOT__w_state;
        CData/*1:0*/ top__DOT__axi_ls_i__DOT__w_state_next;
        CData/*0:0*/ top__DOT__axi_ls_i__DOT__aw_valid;
        CData/*0:0*/ top__DOT__axi_ls_i__DOT__w_valid;
        CData/*0:0*/ top__DOT__axi_ls_i__DOT__b_ready;
        CData/*0:0*/ top__DOT__axi_ls_i__DOT__trans_ok;
        CData/*1:0*/ top__DOT__axi_ls_i__DOT__r_state;
        CData/*1:0*/ top__DOT__axi_ls_i__DOT__r_state_next;
        CData/*0:0*/ top__DOT__axi_ls_i__DOT__ar_valid;
        CData/*0:0*/ top__DOT__axi_ls_i__DOT__r_ready;
        CData/*0:0*/ top__DOT__axi_ls_i__DOT__instr_valid;
        CData/*0:0*/ top__DOT__axi_ls_i__DOT__instr_valid_reg;
    ...
    struct {
        ...
        QData/*63:0*/ top__DOT__axi_ls_i__DOT__addr_reg;
        QData/*63:0*/ top__DOT__axi_ls_i__DOT__rd_data_reg;
