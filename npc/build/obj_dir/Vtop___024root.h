...
VL_MODULE(Vtop___024root) {
  public:
    ...
    struct {
        CData/*0:0*/ top__DOT__L_S_reg_u__DOT__rst_n;
    ...
    // LOCAL VARIABLES
    CData/*0:0*/ top__DOT____Vcellinp__EX_reg_u__flush;
    ...
    CData/*0:0*/ __Vclklast__TOP__top__DOT__L_S_reg_u__DOT__rst_n;
    VlWide<3>/*95:0*/ top__DOT__ID_reg_u__DOT____Vcellout__id_reg__o_dout;
    VlWide<10>/*314:0*/ top__DOT__EX_reg_u__DOT____Vcellout__id_reg__o_dout;
