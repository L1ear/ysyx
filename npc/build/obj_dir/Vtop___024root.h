...
VL_MODULE(Vtop___024root) {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ top__DOT__axi_if_u__DOT__axi_aw_ready_i;
        CData/*0:0*/ top__DOT__axi_if_u__DOT__axi_aw_valid_o;
        CData/*2:0*/ top__DOT__axi_if_u__DOT__axi_aw_prot_o;
        CData/*3:0*/ top__DOT__axi_if_u__DOT__axi_aw_id_o;
        CData/*0:0*/ top__DOT__axi_if_u__DOT__axi_aw_user_o;
        CData/*7:0*/ top__DOT__axi_if_u__DOT__axi_aw_len_o;
        CData/*2:0*/ top__DOT__axi_if_u__DOT__axi_aw_size_o;
        CData/*1:0*/ top__DOT__axi_if_u__DOT__axi_aw_burst_o;
        CData/*0:0*/ top__DOT__axi_if_u__DOT__axi_aw_lock_o;
        CData/*3:0*/ top__DOT__axi_if_u__DOT__axi_aw_cache_o;
        CData/*3:0*/ top__DOT__axi_if_u__DOT__axi_aw_qos_o;
        CData/*3:0*/ top__DOT__axi_if_u__DOT__axi_aw_region_o;
        CData/*0:0*/ top__DOT__axi_if_u__DOT__axi_w_ready_i;
        CData/*0:0*/ top__DOT__axi_if_u__DOT__axi_w_valid_o;
        CData/*7:0*/ top__DOT__axi_if_u__DOT__axi_w_strb_o;
        CData/*0:0*/ top__DOT__axi_if_u__DOT__axi_w_last_o;
        CData/*0:0*/ top__DOT__axi_if_u__DOT__axi_w_user_o;
        CData/*0:0*/ top__DOT__axi_if_u__DOT__axi_b_ready_o;
        CData/*0:0*/ top__DOT__axi_if_u__DOT__axi_b_valid_i;
        CData/*1:0*/ top__DOT__axi_if_u__DOT__axi_b_resp_i;
        CData/*3:0*/ top__DOT__axi_if_u__DOT__axi_b_id_i;
        CData/*0:0*/ top__DOT__axi_if_u__DOT__axi_b_user_i;
    ...
    struct {
        ...
        QData/*63:0*/ top__DOT__axi_if_u__DOT__data_read_o;
        QData/*63:0*/ top__DOT__axi_if_u__DOT__axi_aw_addr_o;
        QData/*63:0*/ top__DOT__axi_if_u__DOT__axi_w_data_o;
