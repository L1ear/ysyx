...
void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__axi_ls_i__DOT__w_state = 0;
    vlSelf->top__DOT__axi_ls_i__DOT__w_state_next = 0;
    vlSelf->top__DOT__axi_ls_i__DOT__aw_valid = 0;
    vlSelf->top__DOT__axi_ls_i__DOT__w_valid = 0;
    vlSelf->top__DOT__axi_ls_i__DOT__b_ready = 0;
    vlSelf->top__DOT__axi_ls_i__DOT__trans_ok = 0;
    vlSelf->top__DOT__axi_ls_i__DOT__r_state = 0;
    vlSelf->top__DOT__axi_ls_i__DOT__r_state_next = 0;
    vlSelf->top__DOT__axi_ls_i__DOT__ar_valid = 0;
    vlSelf->top__DOT__axi_ls_i__DOT__r_ready = 0;
    vlSelf->top__DOT__axi_ls_i__DOT__instr_valid = 0;
    vlSelf->top__DOT__axi_ls_i__DOT__addr_reg = 0;
    vlSelf->top__DOT__axi_ls_i__DOT__instr_valid_reg = 0;
    vlSelf->top__DOT__axi_ls_i__DOT__rd_data_reg = 0;
