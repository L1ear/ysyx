...
void Vtop___024root__traceChgSub0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->chgQData(oldp+352,(vlSelf->ls_sram_addr),64);
        tracep->chgBit(oldp+354,(vlSelf->ls_sram_rd_en));
        tracep->chgBit(oldp+355,(vlSelf->ls_sram_wr_en));
        tracep->chgQData(oldp+356,(vlSelf->ls_sram_wr_data),64);
        tracep->chgCData(oldp+358,(vlSelf->ls_sram_wr_mask),8);
        tracep->chgBit(oldp+359,(vlSelf->ls_sram_rd_data_valid));
        tracep->chgBit(oldp+360,(vlSelf->ls_sram_wr_data_ok));
        tracep->chgQData(oldp+361,(vlSelf->ls_sram_rd_data),64);
        tracep->chgBit(oldp+363,((1U & (~ (((IData)(vlSelf->top__DOT__ld_use_hazard) 
                                            | (~ (IData)(vlSelf->sram_data_valid))) 
                                           | (IData)(vlSelf->top__DOT__ls_not_ok))))));
        tracep->chgIData(oldp+364,(((1U & (IData)((vlSelf->sram_addr 
                                                   >> 2U)))
        ...
        tracep->chgIData(oldp+372,(((IData)(vlSelf->top__DOT__id_flush)
                                     ? 0U : ((1U & (IData)(
                                                           (vlSelf->sram_addr 
                                                            >> 2U)))
                                              ? (IData)(
        ...
        __Vtemp99[2U] = (IData)((((IData)(vlSelf->top__DOT__id_flush)
                                   ? 0ULL : vlSelf->top__DOT__pc_new) 
                                 >> 0x20U));
        tracep->chgWData(oldp+373,(__Vtemp99),96);
    }
}
