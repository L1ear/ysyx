...
void Vtop___024root__traceChgSub0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
            ...
            tracep->chgQData(oldp+17,(vlSelf->top__DOT__alures_wb),64);
            tracep->chgQData(oldp+19,(vlSelf->top__DOT__lsres_wb),64);
        ...
        tracep->chgQData(oldp+216,(vlSelf->pc_decoding),64);
        tracep->chgQData(oldp+218,(((0U == (0x1fU & 
                                    ...
                                    [(0x1fU & (vlSelf->top__DOT__instr_id 
                                               >> 0x14U))])),64);
        tracep->chgQData(oldp+220,(((0U == (0x1fU & 
                                            (vlSelf->top__DOT__instr_id 
                                             >> 0xfU)))
                                     ? 0ULL : vlSelf->top__DOT__ID_u__DOT__regfile_u__DOT__regfiles
                                    [(0x1fU & (vlSelf->top__DOT__instr_id 
