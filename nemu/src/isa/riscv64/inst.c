...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  //INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulhsu, R, R(dest) = src1 & src2);
  //INSTPAT("0000001 ????? ????? 011 ????? 01100 11", mulhu , R, R(dest) = src1 & src2);
  //INSTPAT("0000001 ????? ????? 000 ????? 01110 11", mulw  , R, R(dest) = src1 & src2);
  //INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div   , R, R(dest) = src1 & src2);
  //INSTPAT("0000001 ????? ????? 101 ????? 01100 11", divu  , R, R(dest) = src1 & src2);
  //INSTPAT("0000001 ????? ????? 100 ????? 01110 11", divw  , R, R(dest) = src1 & src2);
  //INSTPAT("0000001 ????? ????? 101 ????? 01100 11", divuw , R, R(dest) = src1 & src2);
  //INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem   , R, R(dest) = src1 & src2);
  //INSTPAT("0000001 ????? ????? 111 ????? 01100 11", remu  , R, R(dest) = src1 & src2);
  //INSTPAT("0000001 ????? ????? 110 ????? 01110 11", remw  , R, R(dest) = src1 & src2);
  //INSTPAT("0000001 ????? ????? 111 ????? 01110 11", remuw , R, R(dest) = src1 & src2);
