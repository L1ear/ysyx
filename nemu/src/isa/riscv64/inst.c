...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("0000000 ????? ????? 001 ????? 00100 11", slli  , I, R(dest) = src1<<(uint8_t)BITS(src2,5,0));
  INSTPAT("0000000 ????? ????? 101 ????? 00100 11", srli  , I, R(dest) = (word_t)src1>>BITS(src2,5,0));
  INSTPAT("0100000 ????? ????? 101 ????? 00100 11", srai  , I, R(dest) = (sword_t)src1>>BITS(src2,5,0));
  INSTPAT("0000000 ????? ????? 000 ????? 01100 11", add   , R, R(dest) = src1+src2);
  INSTPAT("0100000 ????? ????? 000 ????? 01100 11", sub   , R, R(dest) = src1-src2);
