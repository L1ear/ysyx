...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("??????? ????? ????? 100 ????? 11000 11", blt    , B, s->dnpc = ((sword_t)src1 < (sword_t)src2)?s->snpc:s->pc + dest);
  INSTPAT("??????? ????? ????? 101 ????? 11000 11", bge    , B, s->dnpc = ((sword_t)src1 >= (sword_t)src2)?s->snpc:s->pc + dest);
  INSTPAT("??????? ????? ????? 110 ????? 11000 11", bltu   , B, s->dnpc = (src1 < src2)?s->snpc:s->pc + dest);
  INSTPAT("??????? ????? ????? 111 ????? 11000 11", bgeu   , B, s->dnpc = (src1 >= src2)?s->snpc:s->pc + dest);
  ...
  INSTPAT("0000000 ????? ????? 101 ????? 00100 11", srli  , I, R(dest) = (word_t)src1>>src2);
  INSTPAT("0100000 ????? ????? 101 ????? 00100 11", srai  , I, R(dest) = (sword_t)src1>>src2);
  //INSTPAT("0000000 ????? ????? 000 ????? 01100 11", add   , R, R(dest) = src1<src2?1:0);
  //INSTPAT("0100000 ????? ????? 000 ????? 01100 11", sub   , R, R(dest) = src1<src2?1:0);
  //INSTPAT("0000000 ????? ????? 001 ????? 01100 11", sll   , R, R(dest) = src1<src2?1:0);
  //INSTPAT("0000000 ????? ????? 010 ????? 01100 11", slt   , R, R(dest) = src1<src2?1:0);
  //INSTPAT("0000000 ????? ????? 011 ????? 01100 11", sltu  , R, R(dest) = src1<src2?1:0);
  //INSTPAT("0000000 ????? ????? 100 ????? 01100 11", xor   , R, R(dest) = src1<src2?1:0);
  //INSTPAT("0000000 ????? ????? 101 ????? 01100 11", srl   , R, R(dest) = src1<src2?1:0);
  //INSTPAT("0100000 ????? ????? 101 ????? 01100 11", sra   , R, R(dest) = src1<src2?1:0);
  //INSTPAT("0000000 ????? ????? 110 ????? 01100 11", or    , R, R(dest) = src1<src2?1:0);
  //INSTPAT("0000000 ????? ????? 111 ????? 01100 11", and   , R, R(dest) = src1<src2?1:0);
