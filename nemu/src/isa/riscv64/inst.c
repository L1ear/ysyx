...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("0011000 00010 00000 000 00000 11100 11", mret   , N, s->dnpc = cpu.mepc +4); // R(17) is $a7
  INSTPAT("0000000 00000 00000 000 00000 11100 11", ecall  , N, isa_raise_intr(R(17),s->pc,s)); // R(17) is $a7
